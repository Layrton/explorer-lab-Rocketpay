...
//     console.log(maskedExpirationDate)
...
maskedExpirationDate.on('accept', () => {
  const newMaskedExpirationDate = maskedExpirationDate.value
  const updateExpirationDate = document.querySelector('.cc-expiration .value')
  updateExpirationDate.innerText =
    newMaskedExpirationDate.length === 0 ? '02/32' : newMaskedExpirationDate
})
